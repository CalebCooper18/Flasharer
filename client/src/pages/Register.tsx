...
export default function Register() {
  ...
  return (
    ...
    >
      <form
        className='bg-primary text-white flex justify-center items-center flex-col rounded-lg shadow-md
                w-11/12 h-[600px] mt-5 xss:w-3/4'
        onSubmit={handleSubmit}
      >
        <h2 className='text-base tracking-wider mb-7 text-center xss:text-2xl'>
          Create An Account:
        </h2>
